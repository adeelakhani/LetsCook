      ...
      <body>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center mb-4">
                <Image src="/LetsCookw.png" width={40} height={40} alt="LetsCook" className="object-contain" />
                <h2 className="text-xl ml-2 font-bold text-orange-400">LetsCook</h2>
              </div>
              <p className="text-gray-400">Bringing people together through the joy of cooking.</p>
            </div>
            <div>
              <h3 className="font-semibold mb-4">Quick Links</h3>
              <div className="grid grid-cols-2 gap-2">
                <Link href="/" className="text-gray-400 hover:text-white transition-colors w-fit">
                  Home
                </Link>
                ...
                <Link href="/terms" className="text-gray-400 hover:text-white transition-colors w-fit">
                  Terms & Conditions
                </Link>
              </div>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-700 text-center text-gray-400 text-sm">
            © {new Date().getFullYear()} LetsCook. All rights reserved.
          </div>
        </div>
      </footer>
      </body>
