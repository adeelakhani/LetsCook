...
const recipes = [
    { author: "Adeel Akhani", recipe: "Abu the Monkey (Abdullah Ali Liaqqat)", difficulty: "Easy" },
    { author: "Xerxes Radon", recipe: "abdullah liaqqat dih cheese", difficulty: "Easy" },
...
export default function Cook() {
    return (
        <div className="py-5 bg-gray-100 flex-col justify-center content-center items-center mx-auto text-black">
            <h1 className="text-3xl font-bold mb-5 justify-center content-center text-center items-center mx-auto">LetsCook!</h1>
