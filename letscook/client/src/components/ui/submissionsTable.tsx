            ...
            <Table className="overflow-hidden">
                <TableHeader className="text-xl bg-orange-800">
                    <TableRow>
                        ...
                        <TableHead className="text-white font-bold">Submission Time</TableHead>
                    </TableRow>
                </TableHeader>
                    ...
                    {elements.map((element: any, index: number) => {
                        return (
                            <TableRow 
                                ...
                                `}
                                onClick={() => {
                                    router.push(`/authenticated/user-submissions/${element.recipe.replaceAll(" ", "-")}_${element.user}`);
                                }}
                            ...
                            >
                                ...
                                <TableCell>
                                    {element.submission_time.toDateString()}
                                </TableCell>
                                {/* <TableCell>
