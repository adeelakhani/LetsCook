...
export default function ProfileCardMobile({ user }: ProfileCardProps) {
  return (
    <Card className="bg-white shadow-lg border border-orange-200 overflow-hidden hover:shadow-xl transition-all duration-300 block sm:hidden">
      ...
      <CardContent className="p-4">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-4 text-center border border-orange-200">
            ...
            <p className="text-2xl font-bold text-orange-600">{user.meals_cooked}</p>
            <p className="text-xs text-gray-600 font-medium">Meals Cooked</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-4 text-center border border-orange-200">
            ...
            <p className="text-2xl font-bold text-orange-600">{user.created_recipes}</p>
            <p className="text-xs text-gray-600 font-medium">Recipes Created</p>
          </div>
        </div>
