...
export default function ProfileChartMobile({ elements }: ChartData) {
  ...
  return (
    <Card className="bg-white shadow-lg border border-orange-200 overflow-hidden block sm:hidden">
